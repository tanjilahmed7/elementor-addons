 ...
 * Elementor HT Slider
 *
 * Elementor widget for HT Slider.
 *
 * @since 1.0.0
 */

class HT_Slider extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .hubtag-slick-slider  {{CURRENT_ITEM}} .slide-content-wrapper' => 'background-color: {{VALUE}};',
				],
				'conditions' => [
					'terms' => [
						[
