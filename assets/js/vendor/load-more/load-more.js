(function($) {
    ...
    window.htLoadMore = function(options, settings) {
        ...
        optionsValue.loadMoreBtn.on("click", function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    ht_show_image: settingsValue.showImage,
                    image_size: settingsValue.imageSize,
                    ht_show_title: settingsValue.showTitle,
                    ht_show_meta: settingsValue.showMeta,
                    meta_position: settingsValue.metaPosition,

                    ht_show_excerpt: settingsValue.showExcerpt,
                    ht_excerpt_length: settingsValue.excerptLength,
                    ...
                    ht_post_grid_hover_animation:
                        settingsValue.hover_animation,
                    ht_post_grid_bg_hover_icon: settingsValue.hover_icon
                },
                beforeSend: function() {
                ...
                success: function(response) {
                    ...
                    if (optionsValue.postStyle === "grid") {
                        setTimeout(function() {
                            ...
                            optionsValue.postContainer.masonry({
                                itemSelector: ".ht-grid-post",
                                percentPosition: true,
                                columnWidth: ".ht-post-grid-column"
                            });
                        }, 100);
                    } else {
