                    ...
                    if($scope.find('.hubtag-slick-slider').length > 0){
                        var config          = $scope.find('.hubtag-slick-slider').data('config'), 
                            ...
                            if (config.navigation == "both") {
                                ...
                                slickConfig.nextArrow = '<button type="button" class="slick-next ht-slider-arrows"><i class="fa fa-angle-right"></i></button>';
                                slickConfig.prevArrow = '<button type="button" class="slick-prev ht-slider-arrows"><i class="fa fa-angle-left"></i></button>';                                 
                            ...
                            if (slickConfig) {
                                console.log(config.navigation_tb);
