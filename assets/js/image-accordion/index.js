var ImageAccordion = function($scope, $) {
    var $imageAccordion = $scope.find(".ht-img-accordion").eq(0),
        $id =
    ...
    if ("on-click" === $type) {
        $("#ht-img-accordion-" + $id + " a").on("click", function(e) {
            if ($(this).hasClass("overlay-active") == false) {
                e.preventDefault();
            }

            $("#ht-img-accordion-" + $id + " a").css("flex", "1");
            $(this)
                .find(".overlay")
                .parent("a")
                .addClass("overlay-active");
            $("#ht-img-accordion-" + $id + " a")
                .find(".overlay-inner")
        ...
        $("#ht-img-accordion-" + $id + " a").on("blur", function(e) {
            $("#ht-img-accordion-" + $id + " a").css("flex", "1");
            $("#ht-img-accordion-" + $id + " a")
                .find(".overlay-inner")
                .removeClass("overlay-inner-show");
...
jQuery(window).on("elementor/frontend/init", function() {
    elementorFrontend.hooks.addAction(
        "frontend/element_ready/ht-image-accordion.default",
        ImageAccordion
    );
});
